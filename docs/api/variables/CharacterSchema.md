[@rons-org/core v0.1.7](../index.md) / CharacterSchema
...
[packages/core/src/environment.ts:66](https://github.com/ronsOS/rons/blob/main/packages/core/src/environment.ts#L66)
