# Rons - Multi-Agent-Simulationsframework

# https://github.com/rons-org/rons

# Besuchen Sie https://rons.builders für Support
...
- Hochgradig erweiterbar - erstellen Sie eigene Aktionen und Clients zur Erweiterung von Ronss Fähigkeiten
...
Um Git-Konflikte im Core-Verzeichnis zu vermeiden, empfehlen wir, benutzerdefinierte Aktionen zu einem `custom_actions` -Verzeichnis hinzuzufügen und sie dann in der `ronsConfig.yaml`-Datei zu konfigurieren. Siehe `ronsConfig.example.yaml` als Beispiel.
