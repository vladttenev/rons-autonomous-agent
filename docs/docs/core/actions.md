...
Actions are core building blocks in Rons that define how agents respond to and interact with messages. They allow agents to interact with external systems, modify their behavior, and perform tasks beyond simple message responses.
...
Source: https://github.com/ronsOS/rons/blob/main/packages/core/src/types.ts
...
Source: https://github.com/ronsOS/rons/blob/main/packages/plugin-solana/src/actions/takeOrder.ts
...
```typescript
import { Action, IAgentRuntime, Memory, State } from "@rons-org/core";
