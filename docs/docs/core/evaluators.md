...
```typescript
import { Evaluator, IAgentRuntime, Memory, State } from "@rons-org/core-core";
```
...
Source: https://github.com/rons-org/rons/blob/main/packages/core/src/types.ts
...
Source: https://github.com/rons-org/rons/blob/main/packages/core/__tests__/memory.test.ts
