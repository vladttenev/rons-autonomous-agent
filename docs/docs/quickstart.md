...
```bash
git clone https://github.com/ronsOS/rons.git
```
...
Switch to latest [stable version tag](https://github.com/ronsOS/rons/tags)
...
Rons supports multiple AI models and you set which model to use inside the character JSON file.
...
- **Livepeer**: Set `LIVEPEER_IMAGE_MODEL` to your chosen Livepeer image model, available models [here](https://livepeer-rons.com/)

- **Llama**: Set `XAI_MODEL=meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo`
- **Grok**: Set `XAI_MODEL=grok-beta`
- **OpenAI**: Set `XAI_MODEL=gpt-4o-mini` or `gpt-4o`
- **Livepeer**: Set `SMALL_LIVEPEER_MODEL`,`MEDIUM_LIVEPEER_MODEL`,`LARGE_LIVEPEER_MODEL` and `IMAGE_LIVEPEER_MODEL` to your desired models listed [here](https://livepeer-rons.com/).
...
pnpm add -D ts-node typescript @types/node --filter "@rons-org/agent"

# Also add to the core package since it's needed there too
pnpm add -D ts-node typescript @types/node --filter "@rons-org/core"
...
```
Error starting agents: Error: The module '.../rons-agents/dv/rons/node_modules/better-sqlite3/build/Release/better_sqlite3.node'
...
For detailed API documentation, troubleshooting, and advanced features, check out our [full documentation](https://rons-org.github.io/rons/).
