...
Que pouvez-vous faire avec Rons?
...
# personnalisez votre Rons

### ajouter un comportement régulier

Pour éviter les conflits Git dans le répertoire core, nous vous recommandons d’ajouter les actions personnalisées dans le répertoire custom_actions et de les configurer dans le fichier ronsconfig.yaml. Vous pouvez consulter l’exemple dans le fichier ronsconfig.example.yaml.
