...
description: Guide for setting up Rons on Windows using WSL (Windows Subsystem for Linux)
---

# WSL Setup Guide

Steps to run Rons on Windows computer using WSL.
...
```bash
sudo chown -R $USER:$USER ~/path/to/rons
```
