...
You can customize your character's behavior by overriding default prompt templates in your character's JSON file. rons-org/rons provides default prompts for standard behaviors, making all template fields optional.
