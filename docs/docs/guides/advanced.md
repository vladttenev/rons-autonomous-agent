...
This guide covers advanced features and capabilities of Rons, including complex integrations, custom services, and specialized plugins.

## Service Integration

### Video Processing Service

Rons supports advanced video processing capabilities through the `VideoService`:

```typescript
import { VideoService } from "@rons-org/core/plugin-node";
...
```typescript
import { ImageDescriptionService } from "@rons-org/core/plugin-node";
...
```typescript
import { solanaPlugin } from "@rons-org/core/plugin-solana";
...
const customPlugin: Plugin = {
    name: "custom-plugin",
    description: "Custom Plugin for Rons",
    actions: [
        // Custom actions
    ],
    evaluators: [
...
```typescript
const debug = require("debug")("rons:advanced");
...
- [Rons in TEE](../advanced/rons-in-tee.md) for TEE integration
