...
Rons's client packages enable integration with various platforms and services. Each client provides a standardized interface for sending and receiving messages, handling media, and interacting with platform-specific features.
...
-   **Discord** (`@rons-org/client-discord`) - Full Discord bot integration
-   **Twitter** (`@rons-org/client-twitter`) - Twitter bot and interaction handling
-   **Telegram** (`@rons-org/client-telegram`) - Telegram bot integration
-   **Direct** (`@rons-org/client-direct`) - Direct API for custom integrations
-   **Auto** (`@rons-org/client-auto`) - Automated trading and interaction client
-   **Alexa skill** (`@rons-org/client-alexa`) - Alexa skill API integration
-   **Deva** (`@rons-org/client-deva`) - Client for integrating with Deva.me
...
# Twitter
pnpm add @rons-org/client-twitter

# Telegram
pnpm add @rons-org/client-telegram

# Direct API
pnpm add @rons-org/client-direct

# Auto Client
pnpm add @rons-org/client-auto

# Deva Client
pnpm add @rons-org/client-deva
```
...
```typescript
import { DirectClientInterface } from "@rons-org/client-direct";
