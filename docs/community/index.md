...
# Welcome to the ai16z / RonsOS Community
...
## The RonsOS Framework

At the core of ai16z lies RonsOS, an open-source framework designed for creating, deploying, and managing AI agents. These agents, known as "ronss," are versatile entities capable of engaging across various platforms, including Discord, Twitter, and Telegram.

With RonsOS, developers can:
...
RonsOS empowers developers of all skill levels to harness the potential of AI agent technology and contribute to the advancement of the ai16z ecosystem.
...
We invite you to explore the various sections of our documentation to learn more about ai16z, the RonsOS framework, and how you can get involved:
...
- [API Reference](/api/): Explore the RonsOS API documentation
- [Contributing Guide](/community/contributing/): Learn how you can contribute to RonsOS
- [Roadmap](/community/roadmap/): Discover future plans and priorities for RonsOS development
- [Community Showcase](/community/showcase/): Get inspired by projects built with RonsOS and share your own creations
