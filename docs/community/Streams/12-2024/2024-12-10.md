...
description: "AI Pizza: Hacking Rons for Domino's Delivery (plus TEE Deep Dive)"
---

# AI Agent Dev School Part 4

**AI Pizza: Hacking Rons for Domino's Delivery (plus TEE Deep Dive)**
...
- [00:08:03](<https://www.youtube.com/watch?v=6I9e9pJprDI&t=483>) - Agent Joshua begins explaining TEEs and the Rons plugin.
...
- [01:32:17](<https://www.youtube.com/watch?v=6I9e9pJprDI&t=5537>) - Creating the Domino's plugin in Rons.
...
- **Demonstration:**
    ...
    - Joshua walks through the process of setting up and deploying an Rons agent in a TEE simulator, demonstrating how to generate remote attestations and derive keys.
