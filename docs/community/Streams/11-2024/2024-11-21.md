...
- Tommy: Podcast host
- Shaw: Founder of AI16z, creator of the Rons agent framework
...
1. **Explosive Growth and Innovation**: Rapid development with numerous open-source projects pushing boundaries. Example: AI16z's Rons framework with 80+ contributors.
...
- The crypto AI agent explosion, with projects like Rons, MyShell, Virtuals, and Sentience.
...
- **Shaw (AI16z)**: Founder of AI16z and creator of the Rons framework.
