...
: Stability of core system discussed. Suggestion to split packages for easier maintenance by @Sirkitree(https://github.com/orgs/rons-org/discussions/453). Cygaar fixed the starter issue and will PR shortly (PR#763) as confirmed in https://github.com/rons-org/rons/pull/763.
...
- Is the hackathon running Rons agents?! https://lu.ma/4vt76uvk (asked by @jin)
...
- Add Rons pull request #762 to backlog for Agent Hackathon on Dec 9th (mentioned by @James Young)
