...
- Feature Requests
    - Integrate full autonomy as an option in the Rons GitHub project (suggested by Utility Chad)
- Community Tasks
    - Collaborate immediately on integrating full autonomy into the Rons GitHub project (led by shaw, with a meeting held at TEE hackerhouse involving an "awesome crew")
