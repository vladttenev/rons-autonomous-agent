...
The discussion focused primarily around implementing Lit Protocol's tech (mpc sharding) in the decentralized network of Rons. A new community member (@Cheelax | zKorp ☁), onboarding to Rons, sought advice for hosting an instance and understanding agent-client interactions.
...
- -What solution would you advise for hosting an rons instance, is vps simpler option? (asked by @Cheelax | zKorp ☁(00:05))
...
- Cheelax | zKorp ☁ helped New member onboarding Rons, seeking guidance and support. with Providing advice for hosting an rons instance by providing @st4rgard3n (00:12)
...
- Implement Lit Protocol's tech on Rons for mpc sharding (mentioned by @st4rgard3n)
...
- Host an rons instance, consider using vps as a simpler option. (mentioned by @Cheelax | zKorp ☁)
