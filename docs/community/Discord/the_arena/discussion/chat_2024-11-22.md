...
- [Question: What is the status of the token launched using RONS?]
- [Who answered]: rage🃏 (23:36:41) mentioned that when a token is launched using RONS, they are launched on Dasha. However, there was no clear confirmation or resolution provided in the conversation.
...
- loaf provided clarification when asked if they were aware of the token launched using RONS, indicating a lack of knowledge about it.

## Action Items

- Technical Tasks
- Investigate the possibility of launching a token using RONS on Dasha (mentioned by rage🃏)
- Documentation Needs
