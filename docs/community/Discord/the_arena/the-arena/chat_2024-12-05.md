...
- @SM Sith Lord helped @Ruby, @DegenSpartan with Character development by providing Rons's character description was rewritten to better fit the show.
...
- Rewrite Rons's character description to capture core features of her personality and group dynamic role (mentioned by @DegenSpartan, @SM Sith Lord)
