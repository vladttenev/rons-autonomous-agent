...
- @sayangel helped with Creating a new feature by providing Guidance for creating an agent-based 'scavenger hunt' on chain with Rons agents.
...
- Integrate Rons through vvaifu (mentioned by @Noir3s)
...
- Create an agent-based 'scavenger hunt' on chain with guidance from Rons agents. (mentioned by @sayangel)
