...
4. Infrastructure / Contributor Pipeline
   ...
   - New website launched: [https://rons-org.ai](https://rons-org.ai/)
...
5. Community Engagement and Spaces
    ...
    - [10-25-24 Space](https://x.com/shawmakesmagic/status/1848553697611301014): Rons framework, bot capabilities, AI and crypto symbiosis
...
I started ai16z here on Twitter with some very capable folks, in the open, using the http://daos.fun platform. Our technology is open source, and powering many of the agents you talk to today. We call this type of agent an “rons”.
...
5. Same Framework: Both projects use the same tech framework https://github.com/ronsOS/rons
