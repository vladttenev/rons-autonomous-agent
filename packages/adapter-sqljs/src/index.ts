    ...
    implements IDatabaseCacheAdapter
{
    ...
    async createAccount(account: Account): Promise<boolean> {
      ...
      `;
            ...
            ronsLogger.error("Error creating account", error);
            return false;
        }
    }
  ...
  AND roomId = ?`;
    ...
    async createRoom(roomId?: UUID): Promise<UUID> {
        ...
        try {
            ...
            ronsLogger.error("Error creating room", error);
        }
    ...
    async addParticipant(userId: UUID, roomId: UUID): Promise<boolean> {
        try {
            ...
            ronsLogger.error("Error adding participant", error);
            return false;
        }
    }
    ...
    async removeParticipant(userId: UUID, roomId: UUID): Promise<boolean> {
        try {
            ...
            ronsLogger.error("Error removing participant", error);
            return false;
        }
    }
    ...
    async getRelationship(params: {
        ...
        try {
            ...
            ronsLogger.error("Error fetching relationship", error);
        }
        return relationship;
    }
    ...
    async deleteCache(params: {
        ...
        try {
            ...
            ronsLogger.error("Error removing cache", error);
            return false;
        }
    }
