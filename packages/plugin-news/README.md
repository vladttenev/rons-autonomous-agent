...
```bash
npm install @rons-org/plugin-news
```
...
```typescript
import { newsPlugin } from "@rons-org/plugin-news";
...
- `@ai16z/rons`: Core Rons framework
...
Plugin generated from Rons coding tutorial [Agent Dev School Part 2](https://www.youtube.com/watch?v=XenGeAcPAQo)
