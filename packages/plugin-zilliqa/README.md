# @rons-org/plugin-zilliqa

A plugin for integrating Zilliqa blockchain capabilities through the GOAT (Great Onchain Agent Toolkit) framework within the RonsOS ecosystem.
...
This plugin integrates the GOAT Zilliqa plugin and wallet with Rons.

## Installation

```bash
pnpm install @rons-org/plugin-zilliqa
```
