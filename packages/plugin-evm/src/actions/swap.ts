import type { IAgentRuntime, Memory, State } from "@rons-org/core";
import {
    composeContext,
...
export class SwapAction {
    ...
    private async getLifiQuote(
        ...
        try {
            ...
            ronsLogger.error("Error in getLifiQuote:", error.message);
            return undefined;
        }
    }
    ...
    private async getBebopQuote(
        ...
        try {
            ...
            ronsLogger.error("Error in getBebopQuote:", error.message);
            return undefined;
        }
    }
    ...
    private async executeLifiQuote(
        ...
        try {
            ...
            ronsLogger.error(`Failed to execute lifi quote: ${error}`);
            return undefined;
        }
    }
    ...
    private async executeBebopQuote(
        ...
        try {
            ...
            ronsLogger.error(`Failed to execute bebop quote: ${error}`);
            return undefined;
        }
    }
}
...
export const swapAction = {
    ...
    handler: async (
        ...
        ronsLogger.log("Swap action handler called");
        ...
        try {
            ...
            ronsLogger.error("Error in swap handler:", error.message);
            if (callback) {
