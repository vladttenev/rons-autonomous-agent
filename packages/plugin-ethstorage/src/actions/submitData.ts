...
export async function sendData(
    ...
    ronsLogger.log(`tx hash ${txRes.hash}`);
...
export default {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting SUBMIT_DATA handler...");
        ...
        if (content.data != null && content.key !== "") {
            try {
                ...
                ronsLogger.log(`Transaction Data is ${content.data}`);
                ...
                ronsLogger.error("Error during data submission:", error);
                if (callback) {
                    callback({
            ...
            ronsLogger.log("No data mentioned to be submitted");
        }
    },
