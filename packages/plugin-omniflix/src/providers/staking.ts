    ...
    async delegate(
        ...
        try {
            ...
            const tx = await client.delegateTokens(
                ...
                amount,
                "auto",
                "Delegated tokens using Rons"
            );
            return tx;
        } catch (e) {
            ronsLogger.error(`Error in delegate: ${e}`);
            throw e;
        }
    }
    ...
    async undelegate(
        ...
        try {
            ...
            const tx = await client.undelegateTokens(
                ...
                amount,
                "auto",
                "Undelegated tokens using Rons"
            );
            return tx;
        } catch (e) {
            ronsLogger.error(`Error in undelegate: ${e}`);
            throw e;
        }
    }
    ...
    async redelegate(
        ...
        try {
            ...
            const tx = await client.signAndBroadcast(
                ...
                [msg],
                "auto",
                "Redelegated tokens using Rons"
            );
            return tx;
        } catch (e) {
            ronsLogger.error(`Error in redelegate: ${e}`);
            throw e;
        }
    }
    ...
    async cancelUnbondingDelegation(
        ...
        try {
            ...
            const tx = await client.signAndBroadcast(
                ...
                [msg],
                "auto",
                "Cancelled unbonding delegation using Rons"
            );
            return tx;
        } catch (e) {
            ronsLogger.error(`Error in cancelUnbondingDelegation: ${e}`);
            throw e;
        }
    }
}
