...
export class GetBalanceAction {
    async getBalance(
        ...
        try {
            ...
            ronsLogger.info(`Checking balance for address: ${address}`);
            ...
            ronsLogger.info(`Balance of ${address} is ${balanceInFLIX} FLIX`);
            return {
...
export default {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting GET_BALANCE handler...");
