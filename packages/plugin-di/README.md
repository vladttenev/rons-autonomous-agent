# @rons-org/plugin-di - Dependency Injection Plugin for Rons

This plugin provides a dependency injection system for Rons plugins.
...
You can use Dependency Injection in any part of your Rons plugin, including actions, evaluators, providers, services, and clients.
...
```typescript
import { globalContainer } from "@rons-org/plugin-di";
...
```typescript
import { z } from 'zod';
import { property } from "@rons-org/plugin-di";
...
```typescript
import { injectable } from "inversify";
import { BaseInjectableAction } from "@rons-org/plugin-di";
