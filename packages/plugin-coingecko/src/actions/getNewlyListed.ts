...
export default {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting CoinGecko GET_NEW_COINS handler...");
        ...
        try {
            ronsLogger.log("Composing new coins context...");
            ...
            if (!isGetNewCoinsContent(result.object)) {
                ronsLogger.error("Invalid new coins request format");
                return false;
            }
            ...
            ronsLogger.log("Fetching new coins data...");
            ...
            ronsLogger.success("New coins data retrieved successfully!");
            ...
            ronsLogger.error("Error in GET_NEW_COINS handler:", error);
