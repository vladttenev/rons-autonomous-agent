...
export default {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting CoinGecko GET_TOP_GAINERS_LOSERS handler...");
        ...
        try {
            ronsLogger.log("Composing gainers/losers context...");
            ...
            if (!isGetTopGainersLosersContent(result.object)) {
                ronsLogger.error("Invalid gainers/losers request format");
                return false;
            }
            ...
            ronsLogger.log("Fetching top gainers/losers data...");
            ...
            ronsLogger.error("Error in GET_TOP_GAINERS_LOSERS handler:", error);
