...
export default {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting CoinGecko GET_TRENDING handler...");
        ...
        try {
            ...
            ronsLogger.log("Composing trending context...");
            ...
            if (!isGetTrendingContent(result.object)) {
                ronsLogger.error("Invalid trending request format");
                return false;
            }
            ...
            ronsLogger.log("Fetching trending data...");
            ...
            ronsLogger.success("Trending data retrieved successfully!");
            ...
            ronsLogger.error("Error in GET_TRENDING handler:", error);
