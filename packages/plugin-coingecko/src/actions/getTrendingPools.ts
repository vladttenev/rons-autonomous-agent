...
export default {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting CoinGecko GET_TRENDING_POOLS handler...");
        ...
        try {
            ronsLogger.log("Composing trending pools context...");
            ...
            if (!isGetTrendingPoolsContent(result.object)) {
                ronsLogger.error("Invalid trending pools request format");
                return false;
            }
            ...
            ronsLogger.log("Fetching trending pools data...");
            ...
            ronsLogger.success("Trending pools data retrieved successfully!");
            ...
            ronsLogger.error("Error in GET_TRENDING_POOLS handler:", error);
