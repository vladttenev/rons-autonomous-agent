...
export const deployTokenContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        ronsLogger.info("Validating runtime for DEPLOY_TOKEN_CONTRACT...");
        return (
            !!(
    ...
    handler: async (
        ...
        ronsLogger.debug("Starting DEPLOY_TOKEN_CONTRACT handler...");
        ...
        try {
            ...
            ronsLogger.info("Contract details:", contractDetails.object);
            ...
            await contract.wait();
            ronsLogger.info("Deployment details:", deploymentDetails);
            ronsLogger.info("Contract deployed successfully:", contract);
...
Contract deployment has been logged to the CSV file.`,
            ...
            ronsLogger.error("Error deploying token contract:", error);
            callback(
                {
...
export const invokeContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        ronsLogger.info("Validating runtime for INVOKE_CONTRACT...");
        return (
            !!(
                runtime.character.settings.secrets?.COINBASE_API_KEY ||
                process.env.COINBASE_API_KEY
    ...
    handler: async (
        ...
        ronsLogger.debug("Starting INVOKE_CONTRACT handler...");
        ...
        try {
            ...
            ronsLogger.info("Invocation details:", invocationDetails.object);
            ...
            ronsLogger.info("Invocation options:", invocationOptions);
            // Invoke the contract
...
Contract invocation has been logged to the CSV file.`,
            ...
            ronsLogger.error("Error invoking contract method:", error);
            callback(
                {
...
export const readContractAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        ronsLogger.info("Validating runtime for READ_CONTRACT...");
        return (
            !!(
                runtime.character.settings.secrets?.COINBASE_API_KEY ||
                process.env.COINBASE_API_KEY
    ...
    handler: async (
        ...
        ronsLogger.debug("Starting READ_CONTRACT handler...");
        ...
        try {
            ...
            const { contractAddress, method, args, networkId, abi } =
                readDetails.object;
            ronsLogger.info("Reading contract:", {
                contractAddress,
                method,
                args,
                networkId,
            ...
            ronsLogger.info("Contract read result:", serializedResult);
...
- Result: ${JSON.stringify(serializedResult, null, 2)}`,
            ...
            ronsLogger.error("Error reading contract:", error);
            callback(
                {
