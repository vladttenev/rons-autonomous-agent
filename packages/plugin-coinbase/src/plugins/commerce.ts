...
export async function createCharge(apiKey: string, params: ChargeRequest) {
    ronsLogger.debug("Starting createCharge function");
    try {
        ...
        ronsLogger.error("Error creating charge:", error);
        throw error;
    }
}
...
export async function getAllCharges(apiKey: string) {
    ronsLogger.debug("Starting getAllCharges function");
    try {
        const response = await fetch(url, {
            method: "GET",
            headers: {
        ...
        ronsLogger.error("Error fetching charges:", error);
        throw error;
    }
}
...
export async function getChargeDetails(apiKey: string, chargeId: string) {
    ronsLogger.debug("Starting getChargeDetails function");
...
export const createCoinbaseChargeAction: Action = {
    ...
    handler: async (
        ...
        ronsLogger.info("Composing state for message:", message);
        if (!state) {
        ...
        ronsLogger.info("Charge details received:", chargeDetails);

        // Initialize Coinbase Commerce client
        ronsLogger.debug("Starting Coinbase Commerce client initialization");
        try {
            // Create a charge
...
export const getAllChargesAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            ronsLogger.info("Fetched all charges:", charges);
            ...
            ronsLogger.error("Error fetching all charges:", error);
            callback(
                {
...
export const getChargeDetailsAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            ronsLogger.info("Fetched charge details:", chargeDetails);
...
export const chargeProvider: Provider = {
    get: async (runtime: IAgentRuntime, _message: Memory) => {
        ronsLogger.debug("Starting chargeProvider.get function");
        const charges = await getAllCharges(
            runtime.getSetting("COINBASE_COMMERCE_KEY")
        );
        ...
        ronsLogger.info("Charges:", formattedCharges);
