    ...
    implements IDatabaseCacheAdapter
{
    ...
    async searchKnowledge(params: {
        ...
        try {
            ...
            ronsLogger.error("Error in searchKnowledge:", error);
            throw error;
        }
    }
        ...
        try {
            ...
            await this.db.transaction(() => {
                if (id.includes("*")) {
                    ...
                    ronsLogger.debug(`[Knowledge Remove] Checking existence with:
                        Main: ${selectSql} [${id}]
                        Chunks: ${chunkSql} [${id}]`);
                    ...
                    ronsLogger.debug(`[Knowledge Remove] Found:`, {
            ...
            ronsLogger.error("[Knowledge Remove] Error:", {
                id,
                error:
