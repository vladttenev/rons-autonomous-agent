# @rons-org/plugin-anyone

A plugin for integrating Anyone protocol proxy services into Rons agents.

## Installation

```bash
pnpm add @rons-org/plugin-anyone
```
...
```typescript
import { anyonePlugin } from "@rons-org/plugin-anyone";
