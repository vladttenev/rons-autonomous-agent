...
```bash
pnpm install @rons-org/plugin-web-search
```
...
```typescript
import { webSearchPlugin } from "@rons-org/plugin-web-search";
...
```typescript
import { webSearch } from "@rons-org/plugin-web-search";
