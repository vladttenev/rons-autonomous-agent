...
export const getGPUPricingAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, message: Memory): Promise<boolean> => {
        ronsLogger.debug("Validating GPU pricing request", { message });
        try {
            ...
            ronsLogger.error("GPU pricing validation failed", {
    ...
    handler: async (
        ...
        ronsLogger.info("Starting GPU pricing request", { actionId });
        ...
        try {
            ...
            ronsLogger.info("Fetching pricing information", {
                specs: requestBody,
            ...
            ronsLogger.info("Pricing information retrieved successfully", {
                specs: data.spec,
                pricing: {
                    akash: data.akash,
                    aws: data.aws,
            ...
            ronsLogger.error("GPU pricing request failed", {
