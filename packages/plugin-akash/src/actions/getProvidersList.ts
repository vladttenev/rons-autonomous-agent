...
export const getProvidersListAction: Action = {
    ...
    validate: async (runtime: IAgentRuntime, message: Memory): Promise<boolean> => {
        ronsLogger.debug("Validating get providers list request", { message });
        try {
            ...
            ronsLogger.error("Get providers list validation failed", {
    ...
    handler: async (
        ...
        ronsLogger.info("Starting providers list request", { actionId });

        try {
            await validateAkashConfig(runtime);
            const params = message.content as GetProvidersListContent;

            ronsLogger.info("Fetching providers list", {
            ...
            ronsLogger.info("Providers list retrieved successfully", {
            ...
            ronsLogger.error("Get providers list request failed", {
                error: error instanceof Error ? error.message : String(error),
