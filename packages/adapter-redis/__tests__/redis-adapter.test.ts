...
import { type UUID, ronsLogger } from '@rons-org/core';
...
// Mock ronsLogger
vi.mock('@rons-org/core', async () => {
    const actual = await vi.importActual('@rons-org/core');
    return {
        ...actual as any,
        ronsLogger: {
            success: vi.fn(),
...
describe('RedisClient', () => {
    ...
    describe('constructor', () => {
        ...
        it('should log success on connect', () => {
            ...
            connectHandler();
            expect(ronsLogger.success).toHaveBeenCalledWith('Connected to Redis');
        });
        ...
        it('should log error on error event', () => {
            ...
            errorHandler(error);
            expect(ronsLogger.error).toHaveBeenCalledWith('Redis error:', error);
        });
    });
    ...
    describe('getCache', () => {
        ...
        it('should handle errors and return undefined', async () => {
            ...
            expect(mockRedis.get).toHaveBeenCalledWith(expectedRedisKey);
            expect(ronsLogger.error).toHaveBeenCalledWith('Error getting cache:', error);
            expect(result).toBeUndefined();
        });
    });
    ...
    describe('setCache', () => {
        ...
        it('should handle errors and return false', async () => {
            ...
            expect(mockRedis.set).toHaveBeenCalledWith(expectedRedisKey, value);
            expect(ronsLogger.error).toHaveBeenCalledWith('Error setting cache:', error);
    ...
    describe('deleteCache', () => {
        ...
        it('should handle errors and return false', async () => {
            ...
            expect(mockRedis.del).toHaveBeenCalledWith(expectedRedisKey);
            expect(ronsLogger.error).toHaveBeenCalledWith('Error deleting cache:', error);
            expect(result).toBe(false);
        });
    });
    ...
    describe('disconnect', () => {
        it('should successfully disconnect from Redis', async () => {
            ...
            expect(ronsLogger.success).toHaveBeenCalledWith('Disconnected from Redis');
        });
        ...
        it('should handle disconnect errors', async () => {
            ...
            expect(mockRedis.quit).toHaveBeenCalled();
            expect(ronsLogger.error).toHaveBeenCalledWith('Error disconnecting from Redis:', error);
        });
    });
});
