# Binance Plugin for Rons

This plugin enables Rons to interact with the Binance cryptocurrency exchange, providing capabilities for checking prices, executing trades, and managing spot wallet balances.
...
Add the plugin to your Rons configuration:

```json
{
    "plugins": ["@rons-org/plugin-binance"]
}
```
