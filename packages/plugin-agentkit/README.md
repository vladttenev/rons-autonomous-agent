# @rons-org/plugin-agentkit

AgentKit plugin for Rons that enables interaction with CDP AgentKit tools for NFT and token management.
...
```json
{
    "plugins": ["@rons-org/plugin-agentkit"],
    "settings": {
        "secrets": {
            "CDP_API_KEY_NAME": "your_key_name",
            "CDP_API_KEY_PRIVATE_KEY": "your_private_key"
