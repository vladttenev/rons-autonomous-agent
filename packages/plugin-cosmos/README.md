...
Prepare Rons according to [README](../../README.md)
Add variables required for `@rons-org/plugin-cosmos` :
...
Ensure the appropriate environment variables are added for the plugin. If they are correctly configured, the project will run with `@rons-org/plugin-cosmos`
