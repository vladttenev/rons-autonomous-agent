...
export class TransferAction {
    ...
    async transfer(params: TransferParams): Promise<Transaction> {
        try {
            ...
            ronsLogger.error(`Transfer failed: ${error.message}`);
...
export const transferAction: Action = {
    ...
    handler: async (
        ...
        ronsLogger.debug("Starting SEND_TOKEN handler...");
        ...
        ronsLogger.debug("Transfer action handler called");
        ...
        ronsLogger.debug("Transfer paramOptions:", paramOptions);
