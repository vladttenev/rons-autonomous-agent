...
export class WithdrawAction {
    ...
    async withdraw(_params: WithdrawParams): Promise<Hash> {
        try {
            ...
            ronsLogger.log(`Withdraw failed: ${error.message}`);
...
export const withdrawAction: Action = {
    ...
    handler: async (
        ...
        ronsLogger.debug("Starting WITHDRAW handler...");
        ...
        ronsLogger.debug("withdraw action handler called");
        ...
        ronsLogger.debug("Withdraw paramOptions:", paramOptions);
