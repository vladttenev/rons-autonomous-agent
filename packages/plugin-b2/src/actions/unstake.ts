...
export class UnstakeAction {
    ...
    async unstake(params: UnstakeParams): Promise<Hash> {
        try {
            ...
            ronsLogger.error(`Unstake failed: ${error.message}`);
...
export const unstakeAction: Action = {
    ...
    handler: async (
        ...
        ronsLogger.debug("Starting UNSTAKE handler...");
        ...
        ronsLogger.debug("unstake action handler called");
        ...
        ronsLogger.debug("Unstake paramOptions:", paramOptions);
