...
export class StakeAction {
    ...
    async stake(params: StakeParams): Promise<Hash> {
        try {
            ...
            ronsLogger.error(`Stake failed: ${error.message}`);
...
export const stakeAction: Action = {
    ...
    handler: async (
        ...
        ronsLogger.debug("Starting STAKE handler...");
        ...
        ronsLogger.debug("stake action handler called");
        ...
        ronsLogger.debug("Stake paramOptions:", paramOptions);
