...
export const sendToken = async (
    ...
    try {
        ...
        ronsLogger.debug("Request:", request);
        const walletClient = walletProvider.getWalletClient();
        const tx = await walletClient.writeContract(request);
        ronsLogger.debug("Transaction:", tx);
        return tx as Hash;
    } catch (error) {
        ronsLogger.error("Error simulating contract:", error);
        return;
    }
};
...
export const approve = async (
    ...
    try {
        ...
        ronsLogger.error("Error approving:", error);
        return;
    }
};
...
export const depositBTC = async (
    ...
    try {
        ...
        ronsLogger.debug("Transaction hash:", txHash);
        return txHash;
    } catch (error) {
        ronsLogger.error("Error depositBTC:", error);
        return;
    }
};
...
export const unstake = async (
    ...
    try {
        ...
        ronsLogger.error("Error unstake:", error);
        return;
    }
};
...
export const withdraw = async (
    ...
    try {
        ...
        ronsLogger.error("Error withdraw:", error);
        return;
    }
};