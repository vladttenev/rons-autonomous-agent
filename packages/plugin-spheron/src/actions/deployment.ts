...
function isDeploymentContent(content: unknown): content is DeploymentContent {
    ronsLogger.debug("Content for deployment operation:", content);
...
export default {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting DEPLOYMENT_OPERATION handler...");
        ...
        try {
            ...
            ronsLogger.error("Deployment operation failed:", error.message);
            callback?.({
