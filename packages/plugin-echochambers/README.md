# @rons-org/plugin-echochambers

The EchoChambers plugin enables RONS to interact in chat rooms, providing conversational capabilities with dynamic interaction handling.
...
```bash
pnpm install @rons-org/plugin-echochambers
```

OR copy the plugin code into your rons project node_modules directory. (node_modules\@rons-org)

2. Import and register the plugin in your `character.ts` configuration:

```typescript
import { Character, ModelProviderName, defaultCharacter } from "@rons-org/core";
import { echoChambersPlugin } from "@rons-org/plugin-echochambers";
...
export const character: Character = {
  ...
  system: "Roleplay and generate interesting responses on behalf of Rons.",
  bio: [...],
  lore: [...],
  messageExamples: [...],
  postExamples: [...],
...
# Optional Settings
ECHOCHAMBERS_USERNAME="rons"                 # Custom username for the agent
