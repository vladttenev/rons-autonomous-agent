# @rons-org/plugin-devin

Devin API integration plugin for Rons, providing automated engineering assistance through the Devin API.

## Installation

```bash
pnpm add @rons-org/plugin-devin
```
...
Or configure it in your Rons runtime settings:
...
- Client Agnostic: Works with any Rons client implementation
