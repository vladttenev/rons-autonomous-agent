...
class RemoteAttestationProvider {
    ...
    async generateAttestation(
        ...
        try {
            ronsLogger.log("Generating attestation for: ", reportData);
            ...
            ronsLogger.log("Remote attestation quote: ", quote);
            return quote;
        } catch (error) {
...
const remoteAttestationProvider: Provider = {
    get: async (runtime: IAgentRuntime, message: Memory, _state?: State) => {
        ...
        try {
            ...
            ronsLogger.log("Generating attestation for: ", JSON.stringify(attestationMessage));
