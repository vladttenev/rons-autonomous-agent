...
export default {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting Moralis GET_SOLANA_PAIR_OHLCV handler...");
        ...
        try {
            ronsLogger.log("Composing OHLCV request context...");
            const ohlcvContext = composeContext({
                state: currentState,
                template: getPairOHLCVTemplate,
            });

            ronsLogger.log("Extracting OHLCV parameters...");
            ...
            ronsLogger.log("Request params:", params);
            ...
            ronsLogger.log(`Making request to: ${url}`);
            ...
            ronsLogger.log("API Response:", response.data);
            ...
            ronsLogger.error("Error in GET_SOLANA_PAIR_OHLCV handler:", error);
