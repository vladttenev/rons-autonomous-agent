# @rons-org/plugin-dexscreener

A plugin for accessing DexScreener's token data and price information through your Rons agent.

## Installation

```bash
pnpm add @rons-org/plugin-dexscreener
```
...
```typescript
import { dexScreenerPlugin } from "@rons-org/plugin-dexscreener";
