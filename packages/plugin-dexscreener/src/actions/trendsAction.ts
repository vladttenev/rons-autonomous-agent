...
export class LatestTokensAction implements Action {
    ...
    async handler(
        ...
        ronsLogger.log("Starting GET_LATEST_TOKENS handler...");
        ...
        try {
            ...
            ronsLogger.error("Error fetching latest tokens:", error);
...
export class LatestBoostedTokensAction implements Action {
    ...
    async handler(
        ...
        ronsLogger.log("Starting GET_LATEST_BOOSTED_TOKENS handler...");
        ...
        try {
            ...
            ronsLogger.error("Error fetching latest boosted tokens:", error);
...
export class TopBoostedTokensAction implements Action {
    ...
    async handler(
        ...
        ronsLogger.log("Starting GET_TOP_BOOSTED_TOKENS handler...");
        ...
        try {
            ...
            ronsLogger.error("Error fetching top boosted tokens:", error);
