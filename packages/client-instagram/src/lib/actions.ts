...
export async function fetchComments(
  ...
  try {
    ...
    ronsLogger.error('Error fetching comments:', error);
    throw error;
  }
}
...
export async function postComment(
  ...
  try {
    ...
    ronsLogger.error('Error posting comment:', error);
    throw error;
  }
}
...
export async function likeMedia(mediaId: string): Promise<void> {
  ...
  try {
    ...
    ronsLogger.log(`Liked media: ${mediaId}`);
  } catch (error) {
    ronsLogger.error('Error liking media:', error);
    throw error;
  }
}
...
export async function unlikeMedia(mediaId: string): Promise<void> {
  ...
  try {
    ...
    ronsLogger.log(`Unliked media: ${mediaId}`);
  } catch (error) {
    ronsLogger.error('Error unliking media:', error);
    throw error;
  }
}
...
export async function replyToComment(
  ...
  try {
    ...
    ronsLogger.error('Error replying to comment:', error);
    throw error;
  }
}
...
export async function deleteComment(
  ...
  try {
    ...
    ronsLogger.log(`Deleted comment: ${commentId} from media: ${mediaId}`);
  } catch (error) {
    ronsLogger.error('Error deleting comment:', error);
    throw error;
  }
}
...
export async function hasLikedMedia(mediaId: string): Promise<boolean> {
  ...
  try {
    ...
    ronsLogger.error('Error checking if media is liked:', error);
    throw error;
  }
}