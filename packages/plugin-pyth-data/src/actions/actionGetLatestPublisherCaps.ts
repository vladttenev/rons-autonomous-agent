...
const logGranular = (message: string, data?: unknown) => {
    if (GRANULAR_LOG) {
        ronsLogger.info(`[PublisherCaps] ${message}`, data);
        ...
        try {
            ...
            try {
                ...
                if (error instanceof DataError) {
                    ronsLogger.error("Publisher caps validation failed", {
            ...
            ronsLogger.error("Validation failed for GET_LATEST_PUBLISHER_CAPS", {
