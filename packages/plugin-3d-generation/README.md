# @rons-org/plugin-3d-generation

A plugin for generating 3D models using the FAL.ai API within the RonsOS ecosystem.
...
```bash
pnpm install @rons-org/plugin-3d-generation
```
...
```typescript
import { ThreeDGenerationPlugin } from "@rons-org/plugin-3d-generation";
```
