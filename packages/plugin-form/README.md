# @rons-org/plugin-form

A plugin for integrating Form chain capabilities within the RonsOS ecosystem, providing direct access to curves-based token economics and ERC20 conversions.

## Description

[Form Chain](https://form.network/) is a blockchain platform that implements curves-based token economics, allowing users to interact with bonding curves for token creation, trading, and management. This plugin integrates Form chain with Rons, giving your agent the ability to:
...
```bash
pnpm install @rons-org/plugin-form
```
...
## Contributing
This plugin is part of the RonsOS project. See the main project repository Contributing Guide for details.

## License
This plugin is part of the RonsOS project. See the main project repository for license information.
