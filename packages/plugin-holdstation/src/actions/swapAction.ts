...
export class SwapAction {
    ...
    async swap(params: SwapParams): Promise<SwapResult> {
        ...
        ronsLogger.info("--- Swap params:", params);
        ...
        ronsLogger.info("swapUrl:", swapUrl);
        const swapResponse = await fetch(swapUrl);
        const swapData = await swapResponse.json();
        if (!swapData || swapData.error) {
            ronsLogger.error("Swap error:", swapData);
            throw new Error(
...
export const swapAction: Action = {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting HoldStation Wallet TOKEN_SWAP handler...");
        ...
        ronsLogger.info("generate swap content:", content);
        ...
        try {
            ...
            ronsLogger.success(successMessage);
            ...
            ronsLogger.error("Error during token swap:", error);
