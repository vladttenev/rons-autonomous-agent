...
ronsLogger.info("Loading embedding settings:", {
...
ronsLogger.info("Loading character settings:", {
...
export function loadEnvConfig(): Settings {
    ...
    if (!result.error) {
        ronsLogger.log(`Loaded .env file from: ${envPath}`);
    }
...
ronsLogger.info("Parsed settings:", {
