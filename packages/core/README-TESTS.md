...
2. **Environment Variables - NOT REQUIRED** : Set up a `.env` file in the project root (rons) with the necessary environment variables. Copy .env.example file and add required variables.
