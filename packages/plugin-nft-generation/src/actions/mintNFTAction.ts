...
const mintNFTAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            ronsLogger.log("Generate Object:", content);

            if (!isMintNFTContent(content)) {
                ronsLogger.error("Invalid content for MINT_NFT action.");
                if (callback) {
                    callback({
            ...
            if (content?.chainName === "solana") {
                ...
                ronsLogger.log("Collection Info", collectionInfo);
                ...
                if (metadata) {
                    ...
                    ronsLogger.log("NFT Address:", nftRes);
