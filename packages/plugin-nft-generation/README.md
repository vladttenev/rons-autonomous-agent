# @rons-org/plugin-nft-generation

NFT collection generation plugin for Rons OS that enables NFT creation, collection management, and verification on the Solana blockchain.
...
```bash
pnpm install @rons-org/plugin-nft-generation
```
...
- @rons-org/plugin-image-generation: workspace:\*
- @rons-org/plugin-node: workspace:\*
