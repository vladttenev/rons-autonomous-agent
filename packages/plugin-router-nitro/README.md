# @rons-org/plugin-router-nitro

A plugin for interacting with the Router Nitro bridge within the RonsOS ecosystem.
...
```bash
pnpm install @rons-org/plugin-router-nitro
```
...
import {
    nitroPlugin
} from "@rons-org/plugin-router-nitro";
```
