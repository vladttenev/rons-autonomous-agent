# @rons-org/plugin-ferepro

A plugin for enabling WebSocket communication with FerePro API to provide AI-driven market insights within the RonsOS ecosystem.
...
```bash
pnpm install @rons-org/plugin-ferepro
```
