import { type IAgentRuntime, type Plugin, Service, ServiceType } from "@rons-org/core";
...
export const verifiableLogPlugin: Plugin = {
    ...
    description:
        "While Rons operates within the TEE, it uses a derived key pair to sign its actions, ensuring that these actions are definitively executed by Rons. Third-party users can remotely verify Rons's public key to validate these actions",
    actions: [],
    evaluators: [],
    providers: [],
