...
export function getWalletKeypair(runtime?: IAgentRuntime): Keypair {
    ...
    try {
        ...
        ronsLogger.error("Failed to create wallet keypair:", error);
        throw error;
    }
}
...
export async function getWalletBalance(
    ...
    try {
        ...
        ronsLogger.log("Fetched Solana wallet balance:", {
        ...
        ronsLogger.error("Failed to get wallet balance:", error);
        return 0;
    }
}
...
export async function executeTrade(
    ...
    try {
        ronsLogger.log("Executing Solana trade with params:", params);

        const SOL_ADDRESS = "So11111111111111111111111111111111111111112";

        if (!params.isSell && params.amount < SAFETY_LIMITS.MINIMUM_TRADE) {
            ronsLogger.warn("Trade amount too small:", {
        ...
        ronsLogger.log("Trade execution details:", {
        ...
        if (!quoteResponse.ok) {
            ...
            ronsLogger.warn("Quote request failed:", {
        ...
        if (!quoteData || quoteData.error) {
            ronsLogger.warn("Invalid quote data:", quoteData);
            return {
                success: false,
        ...
        ronsLogger.log("Quote received:", quoteData);
        ...
        ronsLogger.log("Swap transaction received");
        ...
        ronsLogger.log("Transaction sent:", signature);
        ...
        ronsLogger.log("Solana trade executed successfully:", {
            signature,
        ...
        ronsLogger.error("Trade execution failed:", {
