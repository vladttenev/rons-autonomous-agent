import { type IAgentRuntime, type Memory, type Evaluator, ronsLogger } from "@rons-org/core";
...
export const trustEvaluator: Evaluator = {
  ...
  handler: async (runtime: IAgentRuntime, message: Memory) => {
    ...
    try {
      ...
      ronsLogger.log("Trust evaluation:", {
        tokenAddress,
        ...evaluation,
      });
      ...
      ronsLogger.error("Trust evaluation failed:", error);
      return false;
    }
  },
};
