import { ronsLogger, type HandlerCallback, type IAgentRuntime, type Plugin, type State } from "@rons-org/core";
import type { Memory } from "@rons-org/core";
...
export const letzAiImageGeneration = {
    ...
    handler: async (
        ...
        try {
            ...
            ronsLogger.log("Composing state for message:", message.content.text);
