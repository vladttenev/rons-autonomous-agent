...
export class GetBalanceAction {
    ...
    async getBalance(params: GetBalanceParams): Promise<GetBalanceResponse> {
        ronsLogger.debug("Get balance params:", params);
        await this.validateAndNormalizeParams(params);
        ronsLogger.debug("Normalized get balance params:", params);
...
export const getBalanceAction = {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting getBalance action...");
        ...
        try {
            ...
            ronsLogger.error("Error during get balance:", error.message);
            callback?.({
