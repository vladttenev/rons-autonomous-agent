...
export class BridgeAction {
    ...
    async bridge(params: BridgeParams): Promise<BridgeResponse> {
        ronsLogger.debug("Bridge params:", params);
        await this.validateAndNormalizeParams(params);
        ronsLogger.debug("Normalized bridge params:", params);
...
export const bridgeAction = {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting bridge action...");
        ...
        try {
            ...
            ronsLogger.error("Error during token bridge:", error.message);
            callback?.({
