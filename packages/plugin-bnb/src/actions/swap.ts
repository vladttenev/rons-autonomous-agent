...
export class SwapAction {
    ...
    async swap(params: SwapParams): Promise<SwapResponse> {
        ronsLogger.debug("Swap params:", params);
        this.validateAndNormalizeParams(params);
        ronsLogger.debug("Normalized swap params:", params);
...
export const swapAction = {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting swap action...");
        ...
        try {
            ...
            ronsLogger.error("Error during swap:", error.message);
            callback?.({
