...
export class TransferAction {
    ...
    async transfer(params: TransferParams): Promise<TransferResponse> {
        ronsLogger.debug("Transfer params:", params);
        this.validateAndNormalizeParams(params);
        ronsLogger.debug("Normalized transfer params:", params);
...
export const transferAction = {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting transfer action...");
        ...
        try {
            ...
            ronsLogger.error("Error during transfer:", error.message);
            callback?.({
