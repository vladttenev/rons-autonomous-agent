...
export class StakeAction {
    ...
    async stake(params: StakeParams): Promise<StakeResponse> {
        ronsLogger.debug("Stake params:", params);
        this.validateStakeParams(params);
        ronsLogger.debug("Normalized stake params:", params);
...
export const stakeAction = {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting stake action...");
        ...
        try {
            ...
            ronsLogger.error("Error during stake:", error.message);
            callback?.({
