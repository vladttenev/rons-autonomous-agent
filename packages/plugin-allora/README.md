# @rons-org/plugin-allora

Seamlessly empowers Rons agents with real-time, advanced, self-improving AI inferences from the Allora Network.

## Installation

```bash
pnpm add @rons-org/plugin-allora
```
...
```typescript
import { alloraPlugin } from "@rons-org/plugin-allora";
...
For detailed information and additional implementation examples, please refer to the [Allora-Rons integration docs](https://docs.allora.network/marketplace/integrations/rons-os).
