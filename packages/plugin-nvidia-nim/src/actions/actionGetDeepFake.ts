import { Action, ronsLogger } from "@rons-org/core";
import { IAgentRuntime, Memory, State, HandlerCallback, ActionExample, Media } from "@rons-org/core";
...
const logGranular = (message: string, data?: unknown) => {
    if (GRANULAR_LOG) {
        ronsLogger.info(`[DeepFakeDetection] ${message}`, data);
...
export const getDeepFakeAction: Action = {
    ...
    validate: async (_runtime: IAgentRuntime, message: Memory): Promise<boolean> => {
        ...
        try {
            ...
            ronsLogger.error("Validation failed for GET_DEEP_FAKE", {
