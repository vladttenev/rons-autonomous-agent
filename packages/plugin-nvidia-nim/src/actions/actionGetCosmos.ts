...
import { IAgentRuntime, Memory, State, HandlerCallback, ActionExample } from "@rons-org/core";
...
const logGranular = (message: string, data?: unknown) => {
    if (GRANULAR_LOG) {
        ronsLogger.info(`[CosmosVision] ${message}`, data);
...
export const getCosmosDescriptionAction: Action = {
    ...
    validate: async (_runtime: IAgentRuntime, message: Memory): Promise<boolean> => {
        ...
        try {
            ...
            ronsLogger.error("Validation failed for GET_COSMOS_DESCRIPTION", {
