# @rons-org/plugin-injective

A comprehensive plugin for interacting with the Injective chain through RonsOS.
...
```bash
npm install @rons-org/plugin-injective
```

## Usage

```typescript
import { InjectiveActions } from '@rons-org/plugin-injective';
```
