# @rons-org/plugin-coinmarketcap

A plugin for Rons that enables cryptocurrency price checking using the CoinMarketCap API.
...
```bash
npm install @rons-org/plugin-coinmarketcap
```
...
3. Register the plugin in your Rons configuration:

```typescript
import { CoinMarketCapPlugin } from "@rons-org/plugin-coinmarketcap";
...
- [GitHub Repository](https://github.com/rons-org/rons/tree/main/packages/plugin-coinmarketcap)
