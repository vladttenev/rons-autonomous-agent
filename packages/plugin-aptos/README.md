# @rons-org/plugin-aptos

A plugin for interacting with the Aptos blockchain network within the RonsOS ecosystem.
...
```bash
pnpm install @rons-org/plugin-aptos
```
