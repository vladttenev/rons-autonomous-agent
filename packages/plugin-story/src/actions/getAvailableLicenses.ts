...
export class GetAvailableLicensesAction {
    ...
    async getAvailableLicenses(
        ...
        try {
            ...
            ronsLogger.log("licenseDetailsResponse", licenseDetailsResponse);
            return licenseDetailsResponse;
        } catch (e) {
            ronsLogger.error("Failed to parse response");
...
export const getAvailableLicensesAction = {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting GET_AVAILABLE_LICENSES handler...");
        ...
        try {
            ...
            ronsLogger.error("Error fetching available licenses:", e.message);
            callback?.({
