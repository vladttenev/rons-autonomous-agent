...
import { type ActionExample, type HandlerCallback, type IAgentRuntime, type Memory, type State, ronsLogger } from "@rons-org/core";
...
export const checkRewardAction: Action = {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting Mind Network MIND_CHECK_VOTING_REWARD handler...");
        ...
        try {
            ...
            ronsLogger.error("Error during checking voting reward:", error);
            if (callback) {
                callback({
