import type { Action } from "@rons-org/core";
import { type ActionExample, type Content, type HandlerCallback, type IAgentRuntime, type Memory, ModelClass, type State, ronsLogger, composeContext, generateObject, } from "@rons-org/core";
import { z } from "zod";
...
export const encryptAction: Action = {
    ...
    handler: async (
        ...
        ronsLogger.log("Starting Mind Network MIND_FHE_ENCRYPT handler...");
        ...
        ronsLogger.log("Data context:", dataContext);
        ...
        try {
            ...
            ronsLogger.error("Error during FHE encryption:", error);
            if (callback) {
                callback({
