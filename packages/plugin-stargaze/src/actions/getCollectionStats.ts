...
export default {
    ...
    validate: async (runtime: IAgentRuntime, _message: Memory) => {
        ronsLogger.log("🔄 Validating Stargaze configuration...");
        try {
    ...
    handler: async (
        ...
        ronsLogger.log("🚀 Starting Stargaze GET_COLLECTION_STATS handler...");
        ...
        try {
            ronsLogger.log("Composing collection stats context...");
...
- Market Cap: ${formatValue(stats.marketCap)} USD`,
                ...
                ronsLogger.log("✅ Sending callback with collection stats:", message);
                callback(message);
            }
