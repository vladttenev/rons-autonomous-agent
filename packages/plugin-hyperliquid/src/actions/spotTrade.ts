...
export const spotTrade: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            ronsLogger.info("Validated order:", validatedOrder);
            ...
            ronsLogger.info("Found token:", tokenInfo.name);
            ...
            ronsLogger.info("Placing order:", orderRequest);
            ...
            ronsLogger.error("Error placing spot order:", error);
            if (callback) {
                callback({
