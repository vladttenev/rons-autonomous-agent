# Hyperliquid Plugin for Rons

This plugin enables interaction with the Hyperliquid DEX through Rons, providing spot trading capabilities.
...
```json
{
    "plugins": ["@rons-org/plugin-hyperliquid"]
}
```
