...
export class WalletProvider {
    ...
    public async sendEGLD({
        ...
        try {
            ...
            ronsLogger.log(`TxHash: ${txHash}`); // Log transaction hash
            ronsLogger.log(
    ...
    public async sendESDT({
        ...
        try {
            ...
            ronsLogger.log(`TxHash: ${txHash}`); // Log transaction hash
            ronsLogger.log(`Transaction URL: ${transactionURL}`); // View Transaction
            return txHash;
        } catch (error) {
    ...
    public async createESDT({
        ...
        try {
            ...
            const transactionURL = this.getTransactionURL(txHash);
            ronsLogger.log(`TxHash: ${txHash}`); // Log the transaction hash
            ronsLogger.log(`Transaction URL: ${transactionURL}`); // View Transaction
