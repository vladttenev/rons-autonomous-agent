# @rons-org/plugin-multiversx

MultiversX blockchain integration plugin for Rons OS that enables token management and transfers.
...
```bash
pnpm install @rons-org/plugin-multiversx
```
...
```typescript
import { multiversxPlugin } from "@rons-org/plugin-multiversx";
