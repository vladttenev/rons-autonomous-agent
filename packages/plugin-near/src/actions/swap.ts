...
async function checkStorageBalance(
    ...
    try {
        ...
        ronsLogger.log(`Error checking storage balance: ${error}`);
        return false;
    }
}
...
async function swapToken(
    ...
    try {
        ...
        ronsLogger.error("Error in swapToken:", error);
        throw error;
    }
}
...
export const executeSwap: Action = {
    ...
    handler: async (
        ...
        if (!isSwapResponse(response)) {
            ronsLogger.log("Missing required parameters, skipping swap");
            const responseMsg = {
        ...
        try {
            ...
            ronsLogger.log("Swap completed successfully!");
