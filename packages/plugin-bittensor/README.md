# @rons-org/plugin-bittensor

A plugin that integrates BitMind's API into RonsOS agents, enabling access to AI services and digital assets powered by the Bittensor network.
...
```bash
pnpm install @rons-org/plugin-bittensor
```
