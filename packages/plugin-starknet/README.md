# @rons-org/plugin-starknet

Core Starknet blockchain plugin for Rons OS that provides essential services and actions for token operations, trading, and DeFi integrations.

## Overview

The Starknet plugin serves as a foundational component of Rons OS, bridging Starknet blockchain capabilities with the Rons ecosystem. It provides crucial services for token operations, trading, portfolio management, and DeFi integrations, enabling both automated and user-directed interactions with the Starknet blockchain.
