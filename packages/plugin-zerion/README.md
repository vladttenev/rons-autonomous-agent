# @rons-org/plugin-zerion

A plugin for Rons that enables fetching wallet portfolio and position data using the Zerion API.
...
```bash
npm install @rons-org/plugin-zerion
```
...
```typescript
import { zerionPlugin } from "@rons-org/plugin-zerion";
...
- [GitHub Repository](https://github.com/rons-org/rons/tree/main/packages/plugin-zerion) 