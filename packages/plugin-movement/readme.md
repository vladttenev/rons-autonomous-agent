# @rons-org/plugin-movement

Movement Network plugin for Rons OS. This plugin enables Movement Network blockchain functionality for your Rons agent.
...
```bash
pnpm add @rons-org/plugin-movement
```
...
{
"name": "Movement Agent",
"plugins": ["@rons-org/plugin-movement"],
"settings": {
"secrets": {
