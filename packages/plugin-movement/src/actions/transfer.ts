...
function isTransferContent(content: unknown): content is TransferContent {
    ronsLogger.debug("Validating transfer content:", content);
    return (
...
export default {
    ...
    validate: async (_runtime: IAgentRuntime, message: Memory) => {
        ...
        ronsLogger.debug("Message text:", message.content?.text);
    ...
    handler: async (
        ...
        ronsLogger.debug("Starting TRANSFER_MOVE handler...");
        ronsLogger.debug("Message:", {
        ...
        try {
            ...
            ronsLogger.debug("Network config:", network);
            ronsLogger.debug(
                "Available networks:",
            ...
            ronsLogger.debug("Transfer successful:", {
