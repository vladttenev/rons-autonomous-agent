# @rons-org/plugin-obsidian

An Obsidian plugin for RONS OS that provides seamless integration with Obsidian vaults, enabling powerful file and note management capabilities.
...
```bash
npm install @rons-org/plugin-obsidian
# or
yarn add @rons-org/plugin-obsidian
# or
pnpm add @rons-org/plugin-obsidian
```
...
Import and register the plugin in your Rons agent configuration:

```typescript
import { obsidianPlugin } from '@rons-org/plugin-obsidian';
...
The plugin provides several actions that can be used with RONS OS:
...
1. Check the [documentation](https://rons-org.github.io/rons/)
2. Open an issue in the repository
3. Join our [Discord community](https://discord.gg/rons-org)
