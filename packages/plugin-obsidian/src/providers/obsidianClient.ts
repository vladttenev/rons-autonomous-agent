...
export class ObsidianProvider {
    ...
    async connect(): Promise<void> {
        ...
        try {
            ...
            ronsLogger.error("Failed to connect to Obsidian:", error.message);
    ...
    async listNotes(): Promise<string[]> {
        ...
        try {
            ...
            ronsLogger.error("Failed to list notes:", error.message);
            throw error;
        }
    }
    ...
    async getNote(path: string): Promise<NoteContent> {
        ...
        try {
            ...
            ronsLogger.error("Failed to fetch note content:", error);
            throw error;
        }
    }
    ...
    async getActiveNote(): Promise<NoteContent> {
        ...
        try {
            ...
            ronsLogger.error("Failed to fetch active note content:", error.message);
            throw error;
        }
    }
    ...
    async saveNote(
        ...
        try {
            ...
            ronsLogger.error("Failed to save note:", error.message);
            throw error;
        }
    }
    ...
    async listFiles(): Promise<string[]> {
        ...
        try {
            ...
            ronsLogger.error("Failed to list files:", error.message);
            throw error;
        }
    }
    ...
    async listDirectoryFiles(directoryPath: string): Promise<string[]> {
        ...
        try {
            ...
            ronsLogger.error("Failed to list directory contents:", error.message);
            throw error;
        }
    }
    ...
    async readFile(path: string): Promise<string> {
        ...
        try {
            ...
            ronsLogger.error("Failed to read file content:", error.message);
            throw error;
        }
    }
    ...
    async openFile(filePath: string): Promise<void> {
        ...
        try {
            ...
            ronsLogger.success(`Successfully opened file: ${filePath}`);
        } catch (error) {
            ronsLogger.error(`Failed to open file '${filePath}':`, error.message);
            throw error;
        }
    }
    ...
    async saveFile(
        ...
        try {
            ...
            ronsLogger.error("Failed to save file:", error.message);
            throw error;
        }
    }
    ...
    async patchFile(
        ...
        try {
            ...
            ronsLogger.error("Failed to patch file content:", error.message);
            throw error;
        }
    }
    ...
    async listCommands(): Promise<{ id: string; name: string }[]> {
        ...
        try {
            ...
            ronsLogger.error("Failed to list commands:", error.message);
            throw error;
        }
    }
    ...
    async executeCommand(commandId: string): Promise<void> {
        ...
        try {
            ...
            ronsLogger.error("Failed to execute command:", error.message);
            throw error;
        }
    }
    ...
    async search(
        ...
        try {
            ...
            ronsLogger.error('Search failed:', error.message);
            throw error;
        }
    }
    ...
    async searchKeywords(
        ...
        try {
            ...
            ronsLogger.success(`Found ${uniqueResults.length} unique results`);
            ronsLogger.debug("Search results:", uniqueResults);
            return uniqueResults;
        } catch (error) {
            ronsLogger.error("Obsidian search failed:", error.message);
            throw error;
        }
    }
    ...
    private async scanDirectoryRecursively(directory = ''): Promise<string[]> {
        ...
        while (dirsToProcess.length > 0) {
            ...
            try {
                ronsLogger.debug("Scanning directory:", currentDir);
                ...
                ronsLogger.error(`Error scanning directory ${currentDir}:`, error);
            }
        }
    ...
    async getAllFiles(): Promise<string[]> {
        ...
        try {
            ronsLogger.debug("Starting file scanning process");
            ...
            ronsLogger.info(`Completed scanning. Found ${allFiles.length} files in vault`);
            ...
            ronsLogger.error("Error in getAllFiles:", error);
            throw error;
        }
    }
    ...
    async createMemoriesFromFiles(): Promise<number> {
        try {
            ronsLogger.info("Starting to create memories from vault files");
            const allFiles = await this.getAllFiles();

            ronsLogger.debug("All files:", allFiles);
            ronsLogger.success(`Found ${allFiles.length} files in vault`);
            //return allFiles;
            ...
            for (const file of allFiles) {
                try {
                    if (file.endsWith('.md')) {
                        ...
                        if (!content) {
                            ronsLogger.warn(`No content found for file: ${file}`);
                            continue;
                        }
                        ...
                        if (
                            ...
                            ronsLogger.debug(`Skipping unchanged file: ${file}`);
                            continue;
                        }
                    ...
                    ronsLogger.error(`Error processing file ${file}:`, error);
                    // continue;
                }
            }

            ronsLogger.success("Finished creating memories from vault notes");

            return allFiles.length;

        } catch (error) {
            ronsLogger.error("Error in createMemoriesFromFiles:", error);
            return 0;
        }
    }
