# @rons-org/plugin-autonome

A plugin that enables launching new Rons agents through the [Autonome platform](https://dev.autonome.fun).

## Installation

```bash
pnpm add @rons-org/plugin-autonome
```
...
```typescript
import { autonomePlugin } from "@rons-org/plugin-autonome";
...
- Launch new Rons agents through the Autonome platform
...
- @rons-org/plugin-tee: workspace:*
- @rons-org/plugin-trustdb: workspace:*
- axios: ^1.7.9
