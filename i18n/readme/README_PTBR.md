...
Para evitar conflitos no diretório core, recomendamos adicionar ações personalizadas a um diretório `custom_actions` e depois adicioná-las ao arquivo `ronsConfig.yaml`. Veja o arquivo `ronsConfig.example.yaml` para um exemplo.
